...
def test_fill_form_fields():
    result_box = field_fills(fullname="Петров Петр Петрович", email="test@example.com",
...
def test_fill_form_fields_with_valid_values(params, driver):
    fullname, email, cur_addr, per_addr = params

    result_box = field_fills(driver=driver, email=email, curr_addr=cur_addr, perm_addr=per_addr)
...
def test_fill_form_with_invalid_email(email, driver):
...
def test_fill_form_with_invalid_fullname(fullname, driver):
...
def test_fill_form_with_invalid_curr_addr(curr_addr, driver):
...
def test_fill_form_with_invalid_perm_addr(perm_addr, driver):
    field_fills(driver=driver, fullname="Иванов Василий Павлович", email="ivanov@example.ru",
